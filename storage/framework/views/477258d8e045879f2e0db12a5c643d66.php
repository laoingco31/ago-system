    ...
    <div class="deep-sea-bg">
        ...
        <div class="mt-6 flex gap-4">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(url('/home')); ?>" class="btn btn-light btn-lg btn-custom">
                    <i class="fas fa-home"></i> Go to Dashboard
                </a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="btn btn-light btn-lg btn-custom">
                    <i class="fas fa-sign-in-alt"></i> Login
                </a>
                <a href="<?php echo e(route('register')); ?>" class="btn btn-outline-light btn-lg btn-custom">
...
<?php /**PATH C:\xampp\htdocs\ago-system\resources\views\welcome.blade.php ENDPATH**/ ?>